package starling.extensions.advancedjoystick
{
	...
	public class JoyStick extends Sprite
	{
		...
		[Embed( source="/../assets/img/skins/default_stick.png" )] private static const dsClassEmbed:Class;
		public static var DEFAULT_STICK:Texture;
		[Embed( source="/../assets/img/skins/default_holder.png" )] private static const dhClassEmbed:Class;
		public static var DEFAULT_HOLDER:Texture;
			...
			activateImmediately:Boolean = true)
		{
			...
			DEFAULT_STICK = Texture.fromBitmap( new dsClassEmbed() );
			DEFAULT_HOLDER = Texture.fromBitmap( new dhClassEmbed() );
