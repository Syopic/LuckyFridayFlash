package ua.com.syo.luckyfriday.view.ui {
	...
	public class GameOverView extends Panel {
		...
		public function GameOverView() {
			...
			gtlegend = new Array();
			gtlegend[0] = "Ты слишком жесток, вот что я тебе должен сказать. Таких,\n как ты, опасно пускать в космос – там все чересчур хрупко,\n да-да, вот именно, хрупко! ";
			...
			sText = new Sprite();
			legend = new TextField(540, 200, " ", Assets.font.fontName, 15, 0xFFFFFF, true);
			arrange();
