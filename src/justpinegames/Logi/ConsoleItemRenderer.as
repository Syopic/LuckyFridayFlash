package justpinegames.Logi 
{
	...
	internal class ConsoleItemRenderer extends Button implements IListItemRenderer
	{
		...
		{
			_index = -1;
			_format = _format ? _format : new BitmapFontTextFormat(new BitmapFont(), 8, labelColor);
			_formatHighlight = _formatHighlight ? _formatHighlight : new BitmapFontTextFormat(new BitmapFont(), 8, labelColorHighlight);
			...
			var labelTextFormat:BitmapFontTextFormat = new BitmapFontTextFormat(new BitmapFont(), 8, labelColor);
