package justpinegames.Logi
{
	...
	public class Console extends Sprite
	{
		...
		private const HORIZONTAL_PADDING: Number = 57;
		...
		public function Console(consoleSettings:ConsoleSettings = null) 
		{
			...
			_formatBackground.letterSpacing = 1;
		...
		private function onAddedToStageHandler(e:Event):void
		{
			...
			var defaultLabelTextFormat:BitmapFontTextFormat = new BitmapFontTextFormat(_defaultFont, 8, _consoleSettings.textColor);
			var downLabelTextFormat:BitmapFontTextFormat = new BitmapFontTextFormat(_defaultFont, 8, _consoleSettings.highlightColor);
		...
		private function setScreenSize(width:Number, height:Number):void 
		{
			...
			_quad.width = width - 50;
			_quad.height = _consoleHeight;
			_quad.x = 50;

			_copyButton.x = width - 40 - HORIZONTAL_PADDING;
			_copyButton.y = -3;
		...
		public function logMessage(message:String):void 
		{
			...
			(getTimer() / 1000).toFixed(3)
			var prefix:String = "[" + (getTimer() / 1000).toFixed(3) + "] : ";
